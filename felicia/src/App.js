...
import './App.css';
import {BrowseRouter as Router, Route, Link, Switch, Redirect, withRouter, NavLink} from "react-router-dom"
...
class App extends Component{
  ...
  constructor(){
    ...
    setBackground(bgColor, txtColor){
      this.myRef.current.background =bgColor;
...
// ////LATIHAN 6.4 - DATA ROUTE DENGAN ARRAY
// class App extends Component{
